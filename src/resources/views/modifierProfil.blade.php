                ...
                <div class="bg-white lg:shadow lg:border-x-2 lg:border-black overflow-hidden w-full ">
                    <div class="px-4 py-5 sm:px-6">
                        ...
                        <div class="bg-white text-center px-4 py-5">
                            <span
                                ...
                                <span
                                    class="relative -z-0 mb-10 ml-1 mr-1 text-center text-2xl font-semibold group  text-white">
                                    MODIFICATION DU COMPTE </span>
                            </span>
                        </div>
                    </div>
                    <div class="border-t border-gray-200">
                        ...
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                <input required value="{{ $user->prenom }}"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-black"
                        ...
                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                <input required value="{{ $user->dateNaissance }}"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-black"
                                    id="date_de_naissance" name="dateNaissance" type="date">
                            </dd>
                        </div>
                        ...
                        <div class="bg-gray-50  px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                <input required value="{{ $lieu->departement }}"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-black"
                                    id="departement" name="departement" type="number">
                            </dd>
                        </div>
                        ...
                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                <input required value="{{ $lieu->ville }}"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-black"
                        ...
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                <input required value="{{ $lieu->codePostal }}"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-black"
                                    id="code_postale" name="codePostal" type="number">
                            </dd>
                        </div>
                        ...
                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                <input required value="{{ $user->mail }}"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-black"
                                    id="email" name="mail" type="email">
                            </dd>
                        </div>
                        ...
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                <input value="{{ $user->numeroTelephone }}"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-black"
                                    id="telephone" name="numeroTelephone" type="numeric">
                            </dd>
                        </div>
                        ...
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                <input
                                    ...
                                    type="checkbox" name="notificationMail" id="notification_email"
                        ...
                        <div class="flex justify-center">
                            <div class="hidden lg:block">
                                <input type="submit"
                                    class="mt-4 mb-8 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-2 "
                                    value="Valider modification" />

                                <!-- DEBUT Boite modale -->
                                <!-- version PC !-->
                                <button
                                    class="mt-4 mb-8 modal-open bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded my-2 ml-8"
                                    type="button" data-modal-toggle="authentication-modal">Supprimer mon compte</button>
                            </div>
                        </div>
                        ...
                        <div class="lg:hidden block">
                            ...
                            <div class="bg-red-100 py-5 flex justify-center">
                                <button
                                    class="modal-open bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded my-2"
                                    type="button" data-modal-toggle="authentication-modal">Supprimer mon compte</button>
                                </dd>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="modal-content py-4 text-left px-6">
                                    ...
                                    <p><input
                                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-black"
                                            id="confirmation_mot_de_passe_suppression" name="password" type="password"></p>

                                    <div class="flex justify-between pt-2">
                                        <button
                                            class="modal-close px-4 bg-indigo-500 p-3 rounded-lg text-white hover:bg-indigo-400">Annuler</button>
                                        <button formaction="{{ route('effacerCompte') }}"
                                            class="px-4 bg-transparent p-3 rounded-lg text-indigo-500 hover:bg-gray-100 hover:text-indigo-400 mr-2 border">Confirmer</button>
                                    </div>
                                </div>
                            </div>
                        </div>
