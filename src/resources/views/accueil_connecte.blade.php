        ...
        <main>
            ...
            <div class="  bg-orange-200 flex items-start">
                ...
                <div class="bg-orange-200 flex items-center justify-center text-gray-300">
                    <div class="relative bg-orange-200 p-2 ">
                            <a href="https://www.google.com"><svg  class="h-7 w-8 absolute left-0 pointer-events-none" fill="white" viewBox="0 0 24 24" stroke="black" strokeWidth={2}>
