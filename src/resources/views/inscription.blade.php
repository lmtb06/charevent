            ...
            <div class="lg:w-1/2 mb-10 lg:border lg:border-black lg:rounded-md bg-white">
                ...
                <div>
                    ...
                    <button type="submit" id="submit" value="S'inscrire"
                        class="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-150  text-white bg-blue-500 hover:bg-blue-400 focus:ring-4 focus:ring-blue-300 font-medium text-sm w-full sm:w-auto px-5 py-2.5 text-center fond-semibold ">
                        VALIDER </button>
