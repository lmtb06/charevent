...
<html>
  ...
  <div class="w-1/2 mb-10 border border-black rounded-md" style="background-color: white;">
    <form class="m-12" method='POST' action="{{ route('inscrireCompte') }}" enctype="multipart/form-data" >
    @csrf
        ...
        <div class="grid xl:grid-cols-2 xl:gap-6">
          ...
          <div class="relative z-0 mb-6 w-full group">
              <input type="text" name="prenom" id="prenom" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-black appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
          ...
          <!--Nom-->
          <div class="relative z-0 mb-6 w-full group">
              <input type="text" name="nom" id="nom" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-black appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div class="grid xl:grid-cols-2 xl:gap-6">
          <!--Date de naissance-->
          <div class="relative z-0 mb-6 w-full group">
              <input type="date" name="birth" id="birth" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-black appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
          ...
          <!--Département-->
          <div class="relative z-0 mb-6 w-full group">
              <input type="number" name="departement" id="departement" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-black appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div class="grid xl:grid-cols-2 xl:gap-6">
          <!--Ville-->
          <div class="relative z-0 mb-6 w-full group">
              <input type="text" name="ville" id="ville" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-black appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
          ...
          <!--Code postale-->
          <div class="relative z-0 mb-6 w-full group">
              <input type="number" name="codeZIP" id="codeZIP" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-black appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div class="grid xl:grid-cols-2 xl:gap-6">
          <!--Téléphone-->
          <div class="relative z-0 mb-6 w-full group">
              <input type="tel" pattern="[0-9]{10}" name="telephone" id="telephone" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-black appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
        ...
        <!--Email-->
        <div class="relative z-0 mb-6 w-full group">
            <input type="email" name="email" id="email" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-black appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
