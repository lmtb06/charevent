    ...
    <body>
        <div class="flex justify-center lg:bg-blue-300">
            <div class="max-w-2xl mt-16 w-max">
                <div
                    class="bg-white lg:shadow lg:border-x-2 lg:border-black lg:shadow-4xl shadow-[#4f4c796e] overflow-hidden w-full ">
                        ...
                        <div class="bg-white px-14 lg:px-4 lg:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <div class="flex mb-8 lg:mb-0 -space-x-1 overflow-hidden">
                                    @if (is_null($user->photo))
                                        <img class="inline-block rounded-full ring-2 ring-white"
                                            ...
                                            alt="Image de profil inconnu">
                                    @else
                                        <img class="inline-block rounded-full ring-2 ring-white"
                                            src="{{ asset('/storage/' . $user->photo) }}" alt="Image de profil">
                                    @endif
                                </div>
                            </dt>
                            <div class="mt-1 text-gray-900 text-center lg:mt-20 lg:ml-20">
                                <span
                                    ...
                                    <span
                                        class="relative -z-0 mb-10 ml-1 mr-1 text-center text-4xl font-semibold group  text-white">
                                        MON COMPTE </span>
                                </span>
                            </div>
                        </div>
                        ...
                        <dl>
                            ...
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <dd class="mt-1 text-gray-900 sm:mt-0 sm:col-span-2">
                                    {{ \Carbon\Carbon::parse($user->dateNaissance)->format('d/m/Y') }}</dd>
                            </div>
                            ...
                            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                @if ($user->numeroTelephone)
                                    <dd class="mt-1 text-gray-900 sm:mt-0 sm:col-span-2">{{ $user->numeroTelephone }}
                                    </dd>
                                @else
                                    <dd class="mt-1 text-gray-900 sm:mt-0 sm:col-span-2">Numéro inconnu</dd>
                                @endif
                            </div>
                        ...
                        @if (Auth::id() == $user->id_compte)
                            <div class="flex justify-center">
                                <a href="{{ route('pageModificationCompte') }}">
                                    <button
                                        class="bg-blue-500 mb-8 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-2 ">
                                        Modifier mon compte
                                    </button>
                                </a>
                                <div>
                                    <button
                                        class="modal-open bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-2 ml-8"
            ...
            <div
                ...
                <div class="modal-container bg-white w-11/12 md:max-w-lg  mx-auto rounded shadow-lg z-50 overflow-y-auto">
                    ...
                    <div class="modal-content py-4 text-left px-6">
                        ...
                        <!--Body-->
                        <form method="POST" action="{{ route('modifierMdp') }}">
                            @csrf
                            ...
                            <p><input
                                    ...
                                    id="hashMDP" name="hashMDP" type="password" required></p>
                            <p>Nouveau mot de passe :</p>
                            <p><input
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-black"
                                    id="mdp" name="mdp" type="password" required></p>
                            <p>Confirmation :</p>
                            <p><input
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-black"
                                    id="mdp_confirmation" name="mdp_confirmation" type="password" required>
                            </p>
